#!/usr/bin/env python3
"""
Detailed orderbook example showing snapshot vs delta processing.
    ...
    if "update:" in topic:
        ...
        if msg_type == "snapshot":
            ...
            if not shown_snapshot:
                print("\n" + "=" * 60)
                print("SNAPSHOT MESSAGE RECEIVED")
                print("=" * 60)
...
def main():
    ...
    print("Detailed Orderbook Processing Example")
    print("=" * 60)
    ...
    print("\nThe orderbook cache maintained a local copy by:")
