#!/usr/bin/env python3
"""
Live orderbook example for BTSE Spot.

This example:
1. Connects to BTSE OSS websocket
...
def main():
    ...
    print(f"Connecting to BTSE orderbook stream for {symbol}...")
    ...
    print("\nLive Orderbook (Press Ctrl+C to stop)")
    print("-" * 60)
